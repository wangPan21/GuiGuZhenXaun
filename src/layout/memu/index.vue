<template>
    <div class="content">
        ...
        <div style="display: flex; align-items: center; justify-content: center;width:100%; ">
            ...
            <span style=" height:25px;padding-top: 3px;  font-size: 22px; overflow:hidden;  font-weight: bolder;"
        ...
        <el-scrollbar height="90vh">
            ...
            <el-menu active-text-color="#ffd04b" background-color="#01152a" :default-active="$route.path" text-color="#fff"
                :router="true" :collapse-transition="true" :collapse="uselayoutStore.fold">
